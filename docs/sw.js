const CACHE='appetito-v1';
const FILES=['./','./index.html','./styles.css','./app.js','./engine.js','./recipes.js','./manifest.webmanifest','./assets/appetito-avatar.png','./assets/appetito-192.png','./assets/appetito-512.png','./assets/botolo.png'];
